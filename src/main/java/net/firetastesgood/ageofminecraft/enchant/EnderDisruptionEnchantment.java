...
public class EnderDisruptionEnchantment extends Enchantment {
    public EnderDisruptionEnchantment(Rarity rarity, EnchantmentCategory cat, EquipmentSlot... slots) {
    ...
    public boolean checkCompatibility(Enchantment other) {
        return !(other instanceof DamageEnchantment)
                ...
                && other != ModEnchantments.CRUSHER.get()
